...
public class Spicejet_payment_page
{
	...
	public void Enter_Card_details(ChromeDriver driver) throws InterruptedException
	{
		driver.switchTo().frame(cardnumberiframe);
		cardnumber.sendKeys("5216 5215 1235 7894 698");
		driver.switchTo().defaultContent();
		Thread.sleep(2000);
		driver.switchTo().frame(cardholderiframe);
		cardholdername.sendKeys("Snehal Raut");
		driver.switchTo().defaultContent();
		Thread.sleep(2000);
		driver.switchTo().frame(cardmonthiframe);
		cardmonth.sendKeys("11");
		driver.switchTo().defaultContent();
		Thread.sleep(2000);
		driver.switchTo().frame(cardyeariframe);
		cardyear.sendKeys("1993");
		driver.switchTo().defaultContent();
		Thread.sleep(2000);
		driver.switchTo().frame(cardyeariframe);
		cardyear.sendKeys("111");
		driver.switchTo().defaultContent();
		Thread.sleep(2000);
	}
...
//		a1.click(clickproceedtopay).build().perform();
	...
	public Spicejet_payment_page(WebDriver Driver)
	{
