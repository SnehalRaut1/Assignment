...
//validate flight info ,fare details.baggage rules and cancellation rules link has the details 
//in the search result page
@Listeners(Listener_class.class)
public class Testcase_10_Spicejet extends Launch_quit
{

	@Test(retryAnalyzer=project_second_airline.Retry_logic_airline.class)
	public void flight_info_baggage_cancellation() throws InterruptedException
	{
		    ...
		    l1.scroll_flightinfo(Driver);
		    l1.click_baggagelink();
		    l1.click_cancellationlink();
		    l1.click_cancellationlink();
